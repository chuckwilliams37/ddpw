...
/**
 * @class Level3_ddpw_administration.Library.Level3.Ddpw.Utilities.Tools.Controllers.ExecutionView.Section
 */
$.Controller('Level3_ddpw_administration.Library.Level3.Ddpw.Utilities.Tools.Controllers.ExecutionView.Section',
	/** @Static */
	{
		defaults : {
			toolType : null,
	...
	/** @Prototype */
	{
		...
		"reactivateSection" : function ( element , event ) {
			...
			//this.enableSectionActions( true );
		...
		saveSectionSelections : function ( event ) {
			var sectionPromptControllers = this.getAllPromptControllers(),				 
				...
				cursor = $applicationController.options.currentTree.createCursor(),
