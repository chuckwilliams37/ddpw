...
/**
 * @class Level3_ddpw_administration.Library.Level3.Ddpw.Utilities.Tools.Controllers.PreviewPanel.MultiSelectDataGridWithFilter
 */
$.Controller('Level3_ddpw_administration.Library.Level3.Ddpw.Utilities.Tools.Controllers.PreviewPanel.MultiSelectDataGridWithFilter',
/** @Static */
{
	defaults : {
		toolType : null,
...
/** @Prototype */
{
	...
	getTableData : function ( fnCallback ) {
		...
		var environmentVariables = this.options.previewPanelController.getEnvironmentVariables(),
		tableDataCall = null,
		dataType = this.options.prompt.selectedEntity ? this.options.prompt.selectedEntity : 'service';
