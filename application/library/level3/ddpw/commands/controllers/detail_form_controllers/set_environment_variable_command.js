 ...
 */
$.Controller('Level3_ddpw_administration.Library.Level3.Ddpw.Commands.Controllers.DetailFormControllers.SetEnvironmentVariableCommand',
/* @Static */
{  	
	defaults : {
	//	createUrlOption : "",
...
/* @Prototype */
{
	init : function () {
	    ...
	    var i =1;
		if( !len  && typeof ( this.options.command.commandData ) != 'undefined' && typeof ( this.options.command.commandData.formParams ) != 'undefined' && typeof ( this.options.command.commandData.formParams.ticketProperties ) != 'undefined')
		{
		...
		var viewHtml = $.View ( "./application/library/level3/ddpw/commands/views/detail_form_renderers/set_environment_variable_command.ejs" , { command : this.options.command ,requiredProperties:this.options.requiredProperties,i:i,environmentVarList:Level3_ddpw_administration.Library.Level3.Ddpw.Commands.SetEnvironmentVariableCommand.getEnvironmentVarList()});
	 ...
	 ".addAnotherCommandOption click" : function (element, event) {
         	...
         	try {
	            var newRenderedView = $.View ( 
	            	"./application/library/level3/ddpw/commands/views/detail_form_renderers/set_env_var_container.ejs" ,
	            	 { 
