...
/**
 * @class Level3_ddpw_administration.Controllers.PreviewPanelItemController
 */
$.Controller('Level3_ddpw_administration.Controllers.PreviewPanelItemController',
/** @Static */
{
	defaults : {
		itemModel:null,
...
{
	init : function(){
		//console.debug ("******************************preview panel ITEM INIT BEGIN****************************", this, arguments);
	...
	getItemRenderer : function (itemModel) {
	    var itemRenderer = Level3_ddpw_administration.Library.Level3.Ddpw.Utilities.ToolFactory.getToolItemRenderer(itemModel.type,"preview_panel");
	...
	refreshView :function () {
		if ( $("#previewPanel").controller().isActive() ) {
			...
			//$thisController.options.itemModel.bind ("selectedResponse", this.onSelectedResponseChange);
		}
	},
